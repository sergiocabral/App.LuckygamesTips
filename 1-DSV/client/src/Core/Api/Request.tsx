namespace Core.Api {
    ...
    export class Request {
        ...
        public static setInstance(instance: Request): void {
            if (this.instance) throw new Error(Core.Locale.Translates.getInstance().get("Está é uma instância global de {name} e não pode ser redefinida.", { name: "Request" }));
        ...
        public static getInstance(): Request {
            if (!this.instance) throw new Error(Core.Locale.Translates.getInstance().get("Está instância global de {name} ainda não foi definida.", { name: "Request" }));
