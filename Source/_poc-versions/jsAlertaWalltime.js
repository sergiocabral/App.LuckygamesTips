...
window.fLoadJQuery = function (fnc) {
...
window.fInitControles = function () {
  if (!window.vInitControles) {
    ...
    jQuery("body").append(
      '<div class="sjcsj" style="position: fixed; top: 10px; left: 10px; color: white; background-color: rgba(255, 255, 255, 0.2); padding: 5px 10px; z-index: 1000000;"></div>'
    );
    jQuery(".sjcsj").append(
    ...
    jQuery(".sjcsj").append(
      '<div><span style="display: inline-block; width: 45px;">R$:</span> <input style="width: 125px; text-align: right;" type="text" id="valBRL" value="0" /></div>'
    );
    jQuery(".sjcsj").append(
      '<div><span style="display: inline-block; width: 45px;">BTC:</span> <input style="width: 125px; text-align: right;" type="text" id="valBTC" value="0" /></div>'
    );
    ...
    jQuery(".sjcsj").append(
      '<div><input type="button" value="Sell" style="width: 45px;" id="btnSell" /> <input style="width: 125px; text-align: right;" type="text" id="alertaSell" value="" /></div>'
    );
    ...
    jQuery(".sjcsj").append(
      '<div><input type="button" value="Buy" style="width: 45px;" id="btnBuy" /> <input style="width: 125px; text-align: right;" type="text" id="alertaBuy" value="" /></div>'
    );
    ...
    jQuery(".sjcsj").append(
      '<div><input type="button" value="Sell" style="width: 45px;" id="btnSell2" /> <input style="width: 125px; text-align: right;" type="text" id="alertaSell2" value="" /></div>'
    );
    ...
    jQuery(".sjcsj").append(
      '<div><input type="button" value="Buy" style="width: 45px;" id="btnBuy2" /> <input style="width: 125px; text-align: right;" type="text" id="alertaBuy2" value="" /></div>'
    );
...
window.getCasasDecimais = function () {
  var exemplo = jQuery("#market-buy tbody tr:nth-child(1) td:nth-child(3) span")
    .text()
    .replaceAll(".", "")
    .replaceAll(",", ".");
...
window.getValBuy = function () {
  var val = jQuery("#market-buy tbody tr:nth-child(1) td:nth-child(3) span")
    .text()
    .replaceAll("R$", "")
    .replaceAll(" ", "")
    .replaceAll(".", "")
...
window.getValSell = function () {
  var val = jQuery("#market-sell tbody tr:nth-child(1) td:nth-child(2) span")
    .text()
    .replaceAll("R$", "")
    .replaceAll(" ", "")
    .replaceAll(".", "")
...
window.getVal = function (selector) {
  ...
  val = parseFloat(val.replaceAll(".", "").replaceAll(",", "."));
  return isNaN(val) ? 0 : val;
};
...
window.getValBRL = function () {
  return getVal("#balance-brl span:nth-child(2)");
};

window.getValBTC = function () {
  return getVal("#balance-xbt span:nth-child(1)");
};
...
window.isLogado = function () {
  var jBRL = jQuery("#balance-brl span:nth-child(2)");
  var jBTC = jQuery("#balance-xbt span:nth-child(1)");

  return jBRL.length && jBRL.length;
};

window.fEfetuarLogin = function () {
  var jBtnLogin = jQuery("#login-button");
...
window.fConfigParams = function () {
  if (!window.vConfigParams) {
    ...
    setValBRLIgnorar(getUrlParam("vBRL"));
    setValBTCIgnorar(getUrlParam("vBTC"));
...
window.fRecarregar = function (force) {
  if (jQuery("#warn-session-will-expire").is(":visible") || force) {
    window.onbeforeunload = null;
    location.href =
      "https://walltime.info/index_pt.html?sjcsj=" +
      Date.now() +
      "&vIsTick=" +
      isTick() +
      "&vBuy=" +
...
window.fTick = function () {
  if (!window.vAudioTick) {
    window.vAudioTick = new Audio(
      "http://debug.splitz.com.br/notify_intervalo_walltime.mp3"
    );
  }
