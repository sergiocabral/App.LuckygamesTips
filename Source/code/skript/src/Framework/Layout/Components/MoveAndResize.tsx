namespace Skript.Framework.Layout.Components {
    ...
    export class MoveAndResize {
        ...
        private onContainerActivate(evt: any): void {
            if (Util.DOM.isBring(this.configuration.elContainer.parentElement as HTMLElement, Types.BackFront.Front)) return;
            ...
            Util.DOM.bring(this.configuration.elContainer.parentElement as HTMLElement, Types.BackFront.Front);
        }
