...
if (window.Glasgow.Modulos) {
    window.Glasgow.Modulos.Estatisticas = window.Glasgow.Modulos.Estatisticas || new (function() {
        ...
        Modulo.Secao = {
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="4" class="sequencias">
                            <h1 title="Análise das sequências&lt;br/&gt;consecutivas perdendo ou vencendo.&lt;br/&gt;No centro é indicado o número de vezes, a sequência.&lt;br/&gt;Nas extremidades se vê quantas vezes ela aconteceu.">Sequências mais recorrentes</h1>
                            <div class="grafico"></div>
                            <div class="controles">
            ...
            js: (container, secaoId) => {
                ...
                container.find('.saldoHistorico .controles input').val(Instancia.Estatisticas.Parametros.LimiteListaSaldoHistorico).blur(function() {
            ...
            atualizarExibicao: () => {
                ...
                Modulo.Objetos.predicaoChartData.series = Instancia.Estatisticas.Dados.Formatado.Predicao();
