window.Cabot = new (function() {
    if (window.Cabot) { return window.Cabot; }
    ...
    this.Definicoes = { 
        ...
        DigitosDecimais: 8,
        Debug: false,
        DesativarGraficos: !!window._cabot_fast,
    };
    ...
    this.LuckygamesIo = new (function(instancia) {
        ...
        this.Multiplicadores[44] = 0.80;
        this.Multiplicadores[45] = 0.83;
        this.Multiplicadores[46] = 0.87;
        this.Multiplicadores[47] = 0.90;
        ...
        this.Multiplicadores[54] = 1.20;
        this.Multiplicadores[55] = 1.25;
        this.Multiplicadores[56] = 1.30;
        ...
        this.Multiplicadores[66] = 2.00;
        this.Multiplicadores[67] = 2.09;
        this.Multiplicadores[68] = 2.19;
        this.Multiplicadores[69] = 2.30;
        ...
        this.Multiplicadores[76] = 3.30;
        this.Multiplicadores[77] = 3.50;
        this.Multiplicadores[78] = 3.71;
        this.Multiplicadores[79] = 3.95;
        this.Multiplicadores[80] = 4.21;
        this.Multiplicadores[81] = 4.50;
        this.Multiplicadores[82] = 4.82;
        this.Multiplicadores[83] = 5.19;
        this.Multiplicadores[84] = 5.60;
        this.Multiplicadores[85] = 6.07;
        this.Multiplicadores[86] = 6.62;
        this.Multiplicadores[87] = 7.25;
        this.Multiplicadores[88] = 8.00;
        this.Multiplicadores[89] = 8.90;
        this.Multiplicadores[90] = 10.00;
        this.Multiplicadores[91] = 11.38;
        this.Multiplicadores[92] = 13.14;
        this.Multiplicadores[93] = 15.50;
        this.Multiplicadores[94] = 18.80;
        this.Multiplicadores[95] = 23.75;
        this.Multiplicadores[96] = 32.00;
        this.Multiplicadores[97] = 48.50;
        this.Multiplicadores[98] = 98.00;
        ...
        this.Apostar = function(parametros) {
            ...
            return new Promise(function(resolve, reject) {
                ...
                const predictionMarcador = '-' + String(Math.random()).slice(-1); $val('#prediction', predictionMarcador);

                _this.Instancia.InterceptadorAjax.Anexar(100, 'request', 'Apostar', function(request) {
                    if (request.game !== 'dice') { return; }
                    if (request.prediction !== predictionMarcador) { return; }
                ...
                _this.Instancia.InterceptadorAjax.Anexar(100, 'response', 'Apostar', function(response, request) {
                    _this.apostaEmExecucao = false;

                    if (response !== null && request !== null) {
                        if (request.game !== 'dice') { return; }
                        if (request.mark !== predictionMarcador) { return; }
                    }

                    Game.animation = backup.animation;

                    _this.Instancia.InterceptadorAjax.Anexar(100, 'request', 'Apostar', null);
                    _this.Instancia.InterceptadorAjax.Anexar(100, 'response', 'Apostar', null);
        ...
        this.DefinirParametrosNaTela = function(parametros) {
            ...
            const fInputText = function(selector, valor, digitosDecimais) {
                ...
                if (valor === '') {
                    ...
                    $(selector).val(_this.Instancia.Geral.NumericoTexto(valor, digitosDecimais, '.'));
                }
            };
            ...
            fInputRadio('.radioBox.left input[type="radio"]', parametros.aoPerderModo);
            fInputText('input[name="on-loss-inc"]', parametros.aoPerderIncrementar, 0);
            fInputText('input[name="on-loss-dec"]', parametros.aoPerderDecrementar, 0);
            ...
            fInputRadio('.radioBox.right input[type="radio"]', parametros.aoVencerModo);
            ...
            fInputText('input[name="balance-under-limit"]', parametros.saldoMinimo, 8);
            ...
            if (trocar) {
                if (!customizado) {
                    if (this.interceptadorClientSeed === null) {
                        ...
                        this.Instancia.InterceptadorAjax.Anexar(300, 'request', 'ClientSeed', function(request) {
                            if (request.action === 'randomizeSeed') {
                                _this.interceptadorClientSeed = true;
                                _this.Instancia.Geral.Toast('Solicitando novo Client Seed ao servidor.');
                            }
                        });
                        this.Instancia.InterceptadorAjax.Anexar(300, 'response', 'ClientSeed', function(response, request) {
                            if (request.action === 'randomizeSeed') {
                                _this.interceptadorClientSeed = false;
                                if (response === null || !response.result) {
                                    _this.Instancia.Geral.Toast('error', 'O Client Seed n&atilde;o foi trocado no modo normal. Ocorreu um erro de comunica&ccedil;&atilde;o com o servidor.');
                                }
                                else {
                                    _this.Instancia.Geral.Toast('Client Seed trocado. Modo normal.');
                                }
                            }
                        });
                    }
                    if (_this.interceptadorClientSeed !== true) {
                        ...
                        _this.Instancia.Geral.Toast('Um novo Client Seed j&aacute; foi solicitado ao servidor, mas ainda n&atilde;o houve resposta.');
                    }
                }
                else {
                    const seed = '0'.repeat(3).split('').map(x => Math.random().toString(15).substr(2)).join('').substr(0, 32);
                    $val('#clientSeed', seed);
    ...
    this.Geral = new (function(instancia) {
        ...
        this.Notificacao = function() {
            try {
                if (this.notificacaoAudio === null) {
                    this.notificacaoAudio = new Audio('https://cabral.br.com/GameBot/alerta-alta.ogg');
                }
        ...
        this.toastMensagens = [];
        this.Toast = function(toast, param2, param3) { if (window.desativarGraficos) return; //TODO: Performance
            ...
            if (arguments.length && typeof(arguments[arguments.length - 1]) === 'boolean') {
                ...
                if (!exibirSempre && (!this.Instancia.Objetos.JanelaModal || !this.Instancia.Objetos.JanelaModal.isOpen)) {
                    return;
                }
            }
            ...
            if (_this.toastMensagens.indexOf(toast.text) < 0) {
                ...
                setTimeout(function() { _this.toastMensagens.shift(); }, 500);
        ...
        this.NumericoTexto = function(valor, digitosDecimais, separadorDecimal) {
            digitosDecimais = digitosDecimais !== undefined ? digitosDecimais : this.Instancia.Definicoes.DigitosDecimais;
            separadorDecimal = separadorDecimal !== undefined ? separadorDecimal : this.Instancia.Definicoes.SeparadorDecimal;

            var valorFloat = parseFloat(typeof(valor) === 'number' ? valor : String(valor).replace(',', '.'));
            var result = isNaN(valorFloat) ? '' : valorFloat.toFixed(digitosDecimais + 1).replace('.', separadorDecimal);
            if (result.length) {
    ...
    this.InterceptadorAjax = new (function(instancia) {
        ...
        this.Ativar = function(modo) {
            if (modo && !(XMLHttpRequest.prototype.sendOriginal instanceof Function)) {
                XMLHttpRequest.prototype.sendOriginal = XMLHttpRequest.prototype.send;
                XMLHttpRequest.prototype.send = this.Instancia.InterceptadorAjax.XMLHttpRequestSend;
        ...
        this.Anexar = function(zIndex, direcao, nome, fInterceptador) {
            ...
            this.Lista[zIndex + nome + (direcao === 'request' ? '_request' : '_response' )] = fInterceptador;
        }
        ...
        this.XMLHttpRequestSend = function(queryString) {
            ...
            if (_this.Instancia.InterceptadorAjax.Ativado) {
                ...
                this.addEventListener('load', _this.Instancia.InterceptadorAjax.XMLHttpRequestLoad);
                this.addEventListener('loadend', _this.Instancia.InterceptadorAjax.XMLHttpRequestLoad);
            }

            if (processarAjax) {
                queryStringArray.length = 0;
                for (key in queryStringJson) {
                    queryStringArray[queryStringArray.length] = [key, queryStringJson[key]]
                }
            ...
            _this.Instancia.Configuracao.Log(_this.Instancia.Geral.FormatarString('Interceptacao Ajax. Ativado: {0}. Processamento autorizado: {1}', _this.Instancia.InterceptadorAjax.Ativado, !!processarAjax), queryStringJson);
        }
        ...
        this.XMLHttpRequestLoad = function(e) {
            ...
            _this.Instancia.Configuracao.Log(_this.Instancia.Geral.FormatarString('Interceptacao Ajax finalizada. Resposta recebida do servidor.'), request, response);
        }
    })(this);
    ...
    this.Layout = new (function(instancia) {
        ...
        this.Montar = function() {
            ...
            `, ':host', '.' + this.Instancia.Definicoes.ClassCss);
        ...
        this.SecoesPadrao = {
            Cabecalho: {
                ...
                Html:
                    ...
                    this.Instancia.Geral.FormatarString('<h1>{0}</h1>', this.Instancia.Definicoes.Nome) +
                    this.Instancia.Geral.FormatarString('<h2>Seu ex&eacute;rcito de rob&ocirc;s que fazem suas apostas valer</h2>') +
                    this.Instancia.Geral.FormatarString('<div><a target="_blank" href="https://luckygames.io/">https://luckygames.io/</a></div>') +
                    this.Instancia.Geral.FormatarString('</div>'),
            }
        }
        ...
        this.AdicionarSecao = function(secao) {
            ...
            if (!$('.' + this.Instancia.Definicoes.ClassCss + '#janela').children().length) {
                this.Instancia.Objetos.Janela.append(this.Instancia.Geral.FormatarString('<div class="secoes"></div><footer>{0}</footer>', this.Instancia.Definicoes.ContatoDoSuporte));
                this.Instancia.Objetos.JanelaSecoes = $('.secoes', this.Instancia.Objetos.Janela);
            ...
            const cssId = 'id' + this.Instancia.Objetos.JanelaSecoes.find('article').length + 1;

            this.Instancia.Geral.CarregarStylesheetCode(this.Instancia.Geral.ReplaceAll(secao.Css, ':host', '.' + this.Instancia.Definicoes.ClassCss + ' article.' + cssId));
            ...
            if (Array.isArray(secao.Botoes)) {
                ...
                for (let i = 0; i < secao.Botoes.length; i++) {
                    html += this.Instancia.Geral.FormatarString('<button class="btn {0}">{1}</button> ', secao.Botoes[i].id, secao.Botoes[i].nome);
                }
                html += '</div>';
            }

            html = this.Instancia.Geral.FormatarString('<article class="{2}">{0}{1}</article>', secao.Html instanceof Function ? secao.Html() : secao.Html, html, cssId);
            if (secao.Titulo) {
                html = 
            ...
            $(".secoes > h1:last", '.' + this.Instancia.Definicoes.ClassCss).click(function() {
                $(this).next().slideToggle();
            });
            secao.Container = $(".secoes > article:last", '.' + this.Instancia.Definicoes.ClassCss);

            this.Configurador.InputNumber($('input[data-tipo="number"]', secao.Container));

            if (secao.Js instanceof Function) { secao.Js(); }

            if (Array.isArray(secao.Botoes)) {
                for (let i = 0; i < secao.Botoes.length; i++) {
                    $('.botoes .btn.' + secao.Botoes[i].id, secao.Container).click(function() {
                        const btn = $(this);
                        if (btn.hasClass('ativo')) { return; }
                        btn.siblings('.btn').removeClass('red').removeClass('ativo');
                        btn.addClass('red').addClass('ativo');
                        if (secao.BotoesFunction instanceof Function) { secao.BotoesFunction(secao.Botoes[i].id, secao.Botoes[i]); }
                    });
                }
        ...
        this.BotaoAtivador = function() {
            ...
            $('body').append(this.Instancia.Geral.FormatarString('<button id="ativador" class="{1} btn blue">{0}</button>', this.Instancia.Definicoes.Nome, this.Instancia.Definicoes.ClassCss));
            this.Instancia.Objetos.BotaoAtivador = $('#ativador.' + this.Instancia.Definicoes.ClassCss).css({ 
                'position': 'fixed', 
                'bottom': '10px',
                'right': '10px',
                'z-index': '10000002',
        ...
        this.Janela = function() {
            const _this = this;
            $('body').append(this.Instancia.Geral.FormatarString('<div id="janela" class="{0}"></div>', this.Instancia.Definicoes.ClassCss));
            this.Instancia.Objetos.Janela = $('#janela.' + this.Instancia.Definicoes.ClassCss);
            this.Instancia.Objetos.JanelaModal = new jBox('Modal', {
                ...
                onOpen: function() {
                    setTimeout(function() {
                        const listaEventos = Array.isArray(_this.Instancia.Layout.OnAbrirJanela) ? _this.Instancia.Layout.OnAbrirJanela : [];
        ...
        this.Configurador = {
            InputNumber: function(selector) {
                ...
                objs.blur(function() {
                    ...
                    data.padrao = parseFloat(String(inputText.attr('data-padrao')).replace(',', '.'));
                    ...
                    data.min = parseFloat(String(inputText.attr('data-min')).replace(',', '.'));
                    data.min = isFinite(data.min) ? data.min : undefined;

                    data.max = parseFloat(String(inputText.attr('data-max')).replace(',', '.'));
                    ...
                    if (typeof(data.valor) === 'number') {
                        ...
                        data.valor = _this.Instancia.Geral.NumericoTexto(data.valor, data.digitos);
                    }
                    ...
                    inputText.valor_number = _this.Instancia.Geral.Numerico(data.valor, null);
    ...
    this.Configuracao = new (function(instancia) {
        ...
        this.Log = function() {
            if (!this.Instancia.Definicoes.Debug) { return; }
            const dataHora = this.Instancia.Geral.FormatarData(new Date());
            let code = 'console.log("' + this.Instancia.Definicoes.Nome + ': " + dataHora';
        ...
        this.CarregarBibliotecas = function() {
            const bibliotecas = [
                ...
                },
                {
                    ...
                    precisaCarregar: function() { return !window.jQuery; },
                },
                {
                    tipo: 'css',
                    url: 'https://cdnjs.cloudflare.com/ajax/libs/jBox/0.4.9/jBox.min.css',
                    precisaCarregar: function() { return !window.jBox; },
                },
                {
                    tipo: 'js',
                ...
                },
                {
                    ...
                    precisaCarregar: function() { return !jQuery.toast; },
                },
                {
                    tipo: 'js',
                ...
                },
                {
                    ...
                    precisaCarregar: function() { return !window.Chartist; },
                },
                {
                    tipo: 'js',
            ...
            const promise = new Promise(function(resolve, reject) {
                const fProcessarCarregamentos = function(index) {
                    ...
                    if (index < bibliotecas.length) {
                        var fRecursivo = function() { fProcessarCarregamentos(++index); }
                        if ((bibliotecas[index].precisaCarregar instanceof Function && bibliotecas[index].precisaCarregar()) ||
                            (!(bibliotecas[index].precisaCarregar instanceof Function) && bibliotecas[index])) {
                            var fCarregarUrl = 
                                bibliotecas[index].tipo === 'css' ? _this.Instancia.Geral.CarregarStylesheet :
                                bibliotecas[index].tipo === 'js' ? _this.Instancia.Geral.CarregarScript :
                                null;
                            _this.Instancia.Configuracao.Log('Carregando: ' + bibliotecas[index].url);
        ...
        this.CarregarModulos = function() {
            for (let i = 0; i < this.Lista.length; i++) {
                ...
                if (this.Lista[i].OnAjaxRequest instanceof Function) {
                    this.Instancia.InterceptadorAjax.Anexar(200, 'request', 'RegraModulo' + this.Instancia.Geral.ZeroEsquerda(i, 3), this.Lista[i].OnAjaxRequest);
                }
                if (this.Lista[i].OnAjaxResponse instanceof Function) {
                    this.Instancia.InterceptadorAjax.Anexar(200, 'response', 'RegraModulo' + this.Instancia.Geral.ZeroEsquerda(i, 3), this.Lista[i].OnAjaxResponse);
                }
            }
        }
        ...
        this.Lista = [
            new (function(instancia) {
                ...
                this.Js = function() {
                    ...
                    _this.Instancia.Objetos.SecaoEstatisticasBtnReiniciar = this.Container.find('.reiniciar');
                    _this.Instancia.Objetos.SecaoEstatisticasBtnReiniciar.click(function() {
                        _this.Dados.ReiniciarValores();
                        _this.Dados.AtualizarCamposDaTela();

                        _this.Instancia.Geral.Toast('Estat&iacute;sticas reiniciadas.', false);
                    });
                ...
                this.Grafico = {
                    Saldo: {
                        Inicializar: function() {
                            ...
                            `, ':host', '.' + _this.Instancia.Definicoes.ClassCss);
                            _this.Instancia.Geral.CarregarStylesheetCode(css);

                            _this.Instancia.Objetos.SecaoEstatisticasGraficoSaldoPontosInput = _this.Container.find('.saldo .pontos input');

                            _this.Instancia.Objetos.SecaoEstatisticasGraficoSaldoDiv = _this.Container.find('.saldo .grafico');
                            _this.Instancia.Objetos.SecaoEstatisticasGraficoSaldoDiv.html('');
                            _this.Instancia.Objetos.SecaoEstatisticasGraficoSaldoData = { series: [ [ ] ] };
                            _this.Instancia.Objetos.SecaoEstatisticasGraficoSaldoChartist = new Chartist.Line(
                                _this.Instancia.Objetos.SecaoEstatisticasGraficoSaldoDiv.get(0), 
                        ...
                        Adicionar: function(valor) { if (window.desativarGraficos) return; //TODO: Performance
                            if (isNaN(parseFloat(valor))) { return; }

                            const limiteDeBarras = _this.Instancia.Objetos.SecaoEstatisticasGraficoSaldoPontosInput.get(0).number();
                            while (limiteDeBarras > 0 && _this.Instancia.Objetos.SecaoEstatisticasGraficoSaldoData.series[0].length > limiteDeBarras) {
                                _this.Instancia.Objetos.SecaoEstatisticasGraficoSaldoData.series[0].shift();
                            }

                            _this.Instancia.Objetos.SecaoEstatisticasGraficoSaldoData.series[0].push(valor);
                            _this.Instancia.Objetos.SecaoEstatisticasGraficoSaldoChartist.update();
                        }
                    },
                    ...
                    Sequencias: {
                        Inicializar: function() {
                            ...
                            _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasContador = _this.Container.find('.sequencias h2 span');

                            _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasDiv = _this.Container.find('.sequencias .grafico');
                            _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasDiv.html('');
                            _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasData = { series: [ [ ], [ ] ] };
                            _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasChartist = new Chartist.Bar(
                                _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasDiv.get(0), 
                        ...
                        Adicionar: function(valor) { if (window.desativarGraficos) return; //TODO: Performance
                            if (isNaN(parseFloat(valor))) { return; }
                            if (valor >= 0) {
                                _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasData.series[0].push(1);
                                _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasData.series[1].push(0);
                            }
                            else {
                                _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasData.series[0].push(0);
                                _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasData.series[1].push(1);
                            }

                            let limiteDeBarras = 10 + (_this.Dados.MaiorSequenciaVencendo() + _this.Dados.MaiorSequenciaPerdendo());
                            limiteDeBarras = limiteDeBarras < 40 ? limiteDeBarras : 40;
                            if (_this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasData.series[0].length > limiteDeBarras) {
                            ...
                            _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasContador.text(_this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasData.series[0].length);
                    ...
                    Sorteados: {
                        Inicializar: function() {
                            ...
                            _this.Instancia.Objetos.SecaoEstatisticasGraficoSorteadosDiv = _this.Container.find('.sorteados .grafico');
                            ...
                            _this.Instancia.Objetos.SecaoEstatisticasGraficoSorteadosChartist = new Chartist.Bar(
                                _this.Instancia.Objetos.SecaoEstatisticasGraficoSorteadosDiv.get(0), 
                                _this.Instancia.Objetos.SecaoEstatisticasGraficoSorteadosData, 
                                {
                                    width: '2500px',
                                    height: '100px',
                        ...
                        Reiniciar: function(valorInicial) {
                            for (let i = 0; i < _this.Instancia.Objetos.SecaoEstatisticasGraficoSorteadosData.series[0].length; i++) {
                                _this.Instancia.Objetos.SecaoEstatisticasGraficoSorteadosData.series[0][i] = 0;
                            }
                        ...
                        Adicionar: function(valor) { if (window.desativarGraficos) return; //TODO: Performance
                            if (isNaN(parseFloat(valor))) { return; }
                            _this.Instancia.Objetos.SecaoEstatisticasGraficoSorteadosData.series[0][valor]++;
                            _this.Instancia.Objetos.SecaoEstatisticasGraficoSorteadosChartist.update();
                        }
                    },
                    ...
                    SequenciasRecorrentes: {
                        Inicializar: function() {
                            ...
                            _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasRecorrentesDiv = _this.Container.find('.sequenciasRecorrentes .grafico');
                            _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasRecorrentesDiv.html('');
                        },

                        Reiniciar: function(valorInicial) {
                            _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasRecorrentesDiv.html('<span>Sem dados para contabilizar</span>');
                            if (!_this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasRecorrentesSequencias) {
                        ...
                        Adicionar: function(resultado, sequencia) { if (window.desativarGraficos) return; //TODO: Performance
                            const fAdicionarBloco = function() {
                                const html = _this.Instancia.Geral.ReplaceAll(`
                                    ...
                                    </div>`, '{seq}', ++_this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasRecorrentesSequencias.contagem);
                                _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasRecorrentesDiv.append(html);
                                return _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasRecorrentesSequencias.contagem;
                            }
                            const fIncrementar = function(resultado, sequencia) {
                                _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasRecorrentesSequencias.winTotal += resultado === 'win' ? 1 : 0;
                                _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasRecorrentesSequencias.loseTotal += resultado === 'lose' ? 1 : 0;
                                const dados = resultado === 'win' ? _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasRecorrentesSequencias.win : resultado === 'lose' ? _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasRecorrentesSequencias.lose : null;
                                dados[sequencia - 1] = dados[sequencia - 1] === undefined ? 1 : dados[sequencia - 1] + 1;
                                $('.sequencia' + sequencia + ' .' + resultado + ' .valor.total', _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasRecorrentesDiv).html(dados[sequencia - 1]);
                            }
                            const fAtualizar = function() {
                                const divs = $('.sequencia', _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasRecorrentesDiv);
                                for (var i = 0; i < divs.length; i++) {
                                    const win = _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasRecorrentesSequencias.win[i] !== undefined ? _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasRecorrentesSequencias.win[i] : 0;
                                    let winPorcento = 100 * win / _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasRecorrentesSequencias.winTotal;
                                    winPorcento = (isNaN(winPorcento) ? 0 : winPorcento).toFixed(2) + '%';

                                    $('.sequencia' + (i + 1) + ' .win .valor.percentual', _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasRecorrentesDiv).html(winPorcento);
                                    $('.sequencia' + (i + 1) + ' .win .barra', _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasRecorrentesDiv).css('width', winPorcento);

                                    const lose = _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasRecorrentesSequencias.lose[i] !== undefined ? _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasRecorrentesSequencias.lose[i] : 0;
                                    let losePorcento = 100 * lose / _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasRecorrentesSequencias.loseTotal;
                                    losePorcento = (isNaN(losePorcento) ? 0 : losePorcento).toFixed(2) + '%';

                                    $('.sequencia' + (i + 1) + ' .lose .valor.percentual', _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasRecorrentesDiv).html(losePorcento);
                                    $('.sequencia' + (i + 1) + ' .lose .barra', _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasRecorrentesDiv).css('width', losePorcento);
                                }
                            }
                            if (sequencia > _this.Instancia.Objetos.SecaoEstatisticasGraficoSequenciasRecorrentesSequencias.contagem) {
                    ...
                    MelhoresApostas: {
                        Inicializar: function() {
                            ...
                            _this.Instancia.Objetos.SecaoEstatisticasGraficoMelhoresApostasUl = _this.Container.find('.melhoresApostas ul');
                        },

                        Reiniciar: function(valorInicial) {
                            _this.Instancia.Objetos.SecaoEstatisticasGraficoMelhoresApostasUl.html('<li>Nenhuma ainda.</li>');
                        ...
                        Adicionar: function(response, request) { if (window.desativarGraficos) return; //TODO: Performance
                            if (!response) { return; }
                            if (response.gameResult === 'lose') { return; }

                            const profit = parseInt(parseFloat(response.profit) * 100000000);
                            if (isNaN(profit)) { return; }

                            const limite = 10;
                            if (_this.Instancia.Objetos.SecaoEstatisticasGraficoMelhoresApostasProfits.length === 0 ||
                                profit > _this.Instancia.Objetos.SecaoEstatisticasGraficoMelhoresApostasProfits[0]) {

                                _this.Instancia.Objetos.SecaoEstatisticasGraficoMelhoresApostasProfits.push(profit);
                                _this.Instancia.Objetos.SecaoEstatisticasGraficoMelhoresApostasProfits.sort((a, b) => a - b);

                                _this.Instancia.Objetos.SecaoEstatisticasGraficoMelhoresApostasProfitsId['id' + profit] = {
                                    id: response.id,
                                    betAmount: request.betAmount.replace('.', ','),
                                    profit: response.profit.replace('.', ','),
                                }
                                
                                while (_this.Instancia.Objetos.SecaoEstatisticasGraficoMelhoresApostasProfits.length > limite) {
                                    const valor = _this.Instancia.Objetos.SecaoEstatisticasGraficoMelhoresApostasProfits.shift();
                                    delete _this.Instancia.Objetos.SecaoEstatisticasGraficoMelhoresApostasProfitsId['id' + valor];
                                }

                                let htmlLi = '';
                                for (let i = 0; i < _this.Instancia.Objetos.SecaoEstatisticasGraficoMelhoresApostasProfits.length; i++) {
                                    const dados = _this.Instancia.Objetos.SecaoEstatisticasGraficoMelhoresApostasProfitsId['id' + _this.Instancia.Objetos.SecaoEstatisticasGraficoMelhoresApostasProfits[i]];
                                    htmlLi = _this.Instancia.Geral.FormatarString('<li><a href="https://luckygames.io/bet/{0}/" target="_blank">{0}</a>: Apostou <span>{1}</span> e ganhou <span>{2}</span></li>', dados.id, dados.betAmount, dados.profit) + htmlLi;
                                }
                                _this.Instancia.Objetos.SecaoEstatisticasGraficoMelhoresApostasUl.html(htmlLi);
                            }
                        }
                    },
                    ...
                    Predicao: {
                        Inicializar: function() {
                            ...
                            _this.Instancia.Objetos.SecaoEstatisticasGraficoPredicaoDiv = _this.Container.find('.predicao .grafico');
                            ...
                            _this.Instancia.Objetos.SecaoEstatisticasGraficoPredicaoChartist = new Chartist.Pie(
                                _this.Instancia.Objetos.SecaoEstatisticasGraficoPredicaoDiv.get(0), 
                                _this.Instancia.Objetos.SecaoEstatisticasGraficoPredicaoData, 
                                {
                                    ...
                                    labelInterpolationFnc: function(value, serie) {
                                        var total = _this.Instancia.Objetos.SecaoEstatisticasGraficoPredicaoData.series[0] + _this.Instancia.Objetos.SecaoEstatisticasGraficoPredicaoData.series[1];
                                        var valor = parseInt((_this.Instancia.Objetos.SecaoEstatisticasGraficoPredicaoData.series[serie] / total) * 100);
                                        return valor + '%';
                                    }
                                });
                        ...
                        Adicionar: function(valor) { if (window.desativarGraficos) return; //TODO: Performance
                            if (_this.Instancia.Objetos.SecaoEstatisticasGraficoPredicaoData.Reiniciado) {
                            ...
                            _this.Instancia.Objetos.SecaoEstatisticasGraficoPredicaoData.series[0] += valor > 0 ? 1 : 0;
                            _this.Instancia.Objetos.SecaoEstatisticasGraficoPredicaoData.series[1] += valor < 0 ? 1 : 0;
                            _this.Instancia.Objetos.SecaoEstatisticasGraficoPredicaoChartist.update();
                        }
                    },
                }
                ...
                this.OnAjaxResponse = function(response, request) {
                    ...
                    _this.Dados.tempoCorrido = _this.Dados.tempoCorrido === null ? new Date() : _this.Dados.tempoCorrido;
                    let horasCorridas = (new Date()).getTime() - _this.Dados.tempoCorrido.getTime();
                    ...
                    _this.Dados.saldoInicial = _this.Dados.saldoInicial !== null ? _this.Dados.saldoInicial : _this.Dados.saldoFinal - _this.Dados.lucroUltimo;
                    ...
                    _this.Dados.maiorAposta = _this.Dados.ultimaAposta > _this.Dados.maiorAposta ? _this.Dados.ultimaAposta : _this.Dados.maiorAposta;
                    _this.Dados.apostasVencidas += response.gameResult === 'win' ? 1 : 0;
                    _this.Dados.apostasPerdidas += response.gameResult === 'lose' ? 1 : 0;
                    _this.Dados.sequenciaVencendo = response.gameResult === 'win' ? _this.Dados.sequenciaVencendo + 1 : 0;
                    _this.Dados.sequenciaPerdendo = response.gameResult === 'lose' ? _this.Dados.sequenciaPerdendo + 1 : 0;
                    _this.Dados.maiorSequenciaVencendo = _this.Dados.sequenciaVencendo > _this.Dados.maiorSequenciaVencendo ? _this.Dados.sequenciaVencendo : _this.Dados.maiorSequenciaVencendo;
                    _this.Dados.maiorSequenciaPerdendo = _this.Dados.sequenciaPerdendo > _this.Dados.maiorSequenciaPerdendo ? _this.Dados.sequenciaPerdendo : _this.Dados.maiorSequenciaPerdendo;
                    _this.Dados.velocidade = _this.Dados.apostasFeitas / horasCorridas;
                    _this.Dados.menorSaldo = _this.Dados.menorSaldo === null || _this.Dados.saldoFinal < _this.Dados.menorSaldo ? _this.Dados.saldoFinal : _this.Dados.menorSaldo;
                    _this.Dados.maiorSaldo = _this.Dados.maiorSaldo === null || _this.Dados.saldoFinal > _this.Dados.maiorSaldo ? _this.Dados.saldoFinal : _this.Dados.maiorSaldo;
                    ...
                    if (sequenciaPerdendo > 0 && _this.Dados.sequenciaPerdendo === 0) {
                        _this.Grafico.SequenciasRecorrentes.Adicionar('lose', sequenciaPerdendo);
                    }
                    if (sequenciaVencendo > 0 && _this.Dados.sequenciaVencendo === 0) {
                        _this.Grafico.SequenciasRecorrentes.Adicionar('win', sequenciaVencendo);
                    }
                };
                ...
                this.Dados = {
                    AtualizarCamposDaTela: function() {
                        ...
                        _this.Dados.MaiorSequenciaVencendo(_this.Dados.maiorSequenciaVencendo);
                        _this.Dados.MaiorSequenciaPerdendo(_this.Dados.maiorSequenciaPerdendo);
                    },
                    ...
                    TempoCorrido: function(valor) {
                        if (valor !== undefined) {
                            ...
                            if (valor instanceof Date) {
                                ...
                                valor = new RegExp('(?<=T).*?(?=\\.)').exec(valor.toISOString())[0];
                            }
                            else {
                                valor = '&dash;';
                                tempoInicio = '&dash;';
                        ...
                        if (isFinite(parseInt(conteudo))) {
                            ...
                            const horaDate = (new Date()).getTime() - (new Date(1969, 11, 2, parseInt(horaString[0]), parseInt(horaString[1]), parseInt(horaString[2]))).getTime();
                    ...
                    Velocidade: function(valor) {
                        if (valor !== undefined) {
                            _this.Container.find('.velocidade').html(_this.Instancia.Geral.NumericoTexto(valor, 2) + ' apostas/min.');
                        }
                        return _this.Instancia.Geral.Numerico(_this.Container.find('.velocidade').text());
                    },
                    apostasFeitas: undefined,
                    ApostasFeitas: function(valor) {
                        if (valor !== undefined) {
                            _this.Container.find('.apostasFeitas').html(_this.Instancia.Geral.NumericoTexto(valor, 0));
                        }
                        return _this.Instancia.Geral.Numerico(_this.Container.find('.apostasFeitas').text());
                    },
                    lucro: undefined,
                    Lucro: function(valor) {
                        if (valor !== undefined) {
                            ...
                            saldoInicial = isNaN(saldoInicial) || saldoInicial === 0 ? 0.00000001 : saldoInicial;
                            const percentual = Math.abs(100 * valor / saldoInicial).toFixed(2) + '%';

                            _this.Container.find('.lucro').html(_this.Instancia.Geral.FormatarString('<span style="color: {3}; display: block;"><span style="font-size: 20px; position: relative; top: 2px; left: -2px; display: inline-block; margin: -10px -3px -2px 0;">{0}</span> {1}</span> <span style="color: {3}; display: block;"><span style="font-size: 20px; position: relative; top: 2px; left: -2px; display: inline-block; margin: -10px -3px -2px 0;">{0}</span> {2}</span>', (valor < 0 ? '- ' : valor > 0 ? '+ ' : ''), _this.Instancia.Geral.NumericoTexto(Math.abs(valor)), percentual, valor < 0 ? 'red' : valor > 0 ? 'blue' : 'black'));
                        }
                        return _this.Instancia.Geral.Numerico(_this.Instancia.Geral.ReplaceAll(_this.Container.find('.lucro span:first-child').text(), ' ', ''));
                    },
                    totalApostado: undefined,
                    TotalApostado: function(valor) {
                        if (valor !== undefined) {
                            _this.Container.find('.totalApostado').html(_this.Instancia.Geral.NumericoTexto(valor));
                        }
                        return _this.Instancia.Geral.Numerico(_this.Container.find('.totalApostado').text());
                    },
                    maiorAposta: undefined,
                    MaiorAposta: function(valor) {
                        if (valor !== undefined) {
                            _this.Container.find('.maiorAposta').html(_this.Instancia.Geral.NumericoTexto(valor));
                        }
                        return _this.Instancia.Geral.Numerico(_this.Container.find('.maiorAposta').text());
                    },
                    ultimaAposta: undefined,
                    UltimaAposta: function(valor) {
                        if (valor !== undefined) {
                            _this.Container.find('.ultimaAposta').html(_this.Instancia.Geral.NumericoTexto(valor));
                        }
                        return _this.Instancia.Geral.Numerico(_this.Container.find('.ultimaAposta').text());
                    },
                    ...
                    MenorSaldo: function(valor) {
                        ...
                        if (valor !== undefined) {
                            ...
                            _this.Container.find('.menorSaldo').html(_this.Instancia.Geral.NumericoTexto(valor));
                        }

                        const result = _this.Container.find('.menorSaldo').text();
                        return _this.Instancia.Geral.Numerico(isFinite(parseFloat(result)) ? result : saldoAtual);
                    },
                    ...
                    MaiorSaldo: function(valor) {
                        ...
                        if (valor !== undefined) {
                            ...
                            _this.Container.find('.maiorSaldo').html(_this.Instancia.Geral.NumericoTexto(valor));
                        }
                    ...
                    SaldoInicial: function(valor) {
                        ...
                        if (valor !== undefined) {
                            ...
                            _this.Container.find('.saldoInicial').html(_this.Instancia.Geral.NumericoTexto(valor));
                        }
                    ...
                    SaldoFinal: function(valor) {
                        ...
                        if (valor !== undefined) {
                            ...
                            _this.Container.find('.saldoFinal').html(_this.Instancia.Geral.FormatarString('<span style="color: {1}">{0}</span>', _this.Instancia.Geral.NumericoTexto(valor), valor > saldoInicial ? 'blue' : valor < saldoInicial ? 'red' : 'black'));
                        }
                    ...
                    ApostasVencidas: function(valor) {
                        if (valor !== undefined) {
                            _this.Container.find('.apostasVencidas').html(_this.Instancia.Geral.NumericoTexto(valor, 0));
                        }
                        return _this.Instancia.Geral.Numerico(_this.Container.find('.apostasVencidas').text());
                    },
                    apostasPerdidas: undefined,
                    ApostasPerdidas: function(valor) {
                        if (valor !== undefined) {
                            _this.Container.find('.apostasPerdidas').html(_this.Instancia.Geral.NumericoTexto(valor, 0));
                        }
                        return _this.Instancia.Geral.Numerico(_this.Container.find('.apostasPerdidas').text());
                    },
                    sequenciaVencendo: undefined,
                    SequenciaVencendo: function(valor) {
                        if (valor !== undefined) {
                            _this.Container.find('.sequenciaVencendo').html(_this.Instancia.Geral.NumericoTexto(valor, 0));
                        }
                        return _this.Instancia.Geral.Numerico(_this.Container.find('.sequenciaVencendo').text());
                    },
                    sequenciaPerdendo: undefined,
                    SequenciaPerdendo: function(valor) {
                        if (valor !== undefined) {
                            _this.Container.find('.sequenciaPerdendo').html(_this.Instancia.Geral.NumericoTexto(valor, 0));
                        }
                        return _this.Instancia.Geral.Numerico(_this.Container.find('.sequenciaPerdendo').text());
                    },
                    maiorSequenciaVencendo: undefined,
                    MaiorSequenciaVencendo: function(valor) {
                        if (valor !== undefined) {
                            _this.Container.find('.maiorSequenciaVencendo').html(_this.Instancia.Geral.NumericoTexto(valor, 0));
                        }
                        return _this.Instancia.Geral.Numerico(_this.Container.find('.maiorSequenciaVencendo').text());
                    },
                    maiorSequenciaPerdendo: undefined,
                    MaiorSequenciaPerdendo: function(valor) {
                        if (valor !== undefined) {
                            _this.Container.find('.maiorSequenciaPerdendo').html(_this.Instancia.Geral.NumericoTexto(valor, 0));
                        }
                        return _this.Instancia.Geral.Numerico(_this.Container.find('.maiorSequenciaPerdendo').text());
                    },
                };
            ...
            new (function(instancia) {
                ...
                this.Js = function() {
                    _this.Instancia.Objetos.SecaoLimitesBtnReiniciar = this.Container.find('.reiniciar');
                    _this.Instancia.Objetos.SecaoLimitesBtnReiniciar.click(function() {
                        _this.Container.find('input[type="text"]').val('').blur();
                        _this.Instancia.Geral.Toast('Todos os limites foram removidos.', false);
                    });
                ...
                this.OnAjaxRequest = function(request) {
                    ...
                    if (!result) {
                        _this.Instancia.Geral.Toast('error', 'Um ou mais limites foram atingidos. A comunica&ccedil;&atilde;o com o servidor foi interrompida.');
                ...
                this.Validar = {
                    ...
                    SaldoMinimo: function() {
                        return _this.Validar.Generico(_this.Instancia.LuckygamesIo.ValorSaldo(), '<=', '.saldoMinimo input');
                    },
                    SaldoMaximo: function() {
                        return _this.Validar.Generico(_this.Instancia.LuckygamesIo.ValorSaldo(), '>=', '.saldoMaximo input');
                    },
                    ApostaMinima: function(betAmount) {
                        return _this.Validar.Generico(parseFloat(betAmount), '<=', '.apostaMinima input');
                    },
                    ApostaMaxima: function(betAmount) {
                        return _this.Validar.Generico(parseFloat(betAmount), '>=', '.apostaMaxima input');
                    },
                    SequenciaPerdendo: function() {
                        const estatisticas = _this.Instancia.Regras.Estatisticas();
                        return _this.Validar.Generico(estatisticas.sequenciaPerdendo, '>=', '.sequenciaPerdendo input');
                    },
                    SequenciaVencendo: function() {
                        const estatisticas = _this.Instancia.Regras.Estatisticas();
                        return _this.Validar.Generico(estatisticas.sequenciaVencendo, '>=', '.sequenciaVencendo input');
                    }
                }
            ...
            new (function(instancia) {
                ...
                this.Js = function() {
                    _this.Instancia.Objetos.SecaoSeedRandomizeInput = this.Container.find('.seed input');
                    _this.Instancia.Objetos.SecaoSeedRandomizeInput.val(_this.Instancia.LuckygamesIo.ClientSeed());

                    _this.Instancia.Objetos.SecaoSeedRandomizeInputTempo = this.Container.find('.tempo input');
                    _this.Instancia.Objetos.SecaoSeedRandomizeInputApostas = this.Container.find('.apostas input');
                    _this.Instancia.Objetos.SecaoSeedRandomizeInputApostasPerdidas = this.Container.find('.apostasPerdidas input');
                    _this.Instancia.Objetos.SecaoSeedRandomizeInputApostasVencidas = this.Container.find('.apostasVencidas input');

                    _this.Instancia.Objetos.SecaoSeedRandomizeInterval = null;
                    _this.Instancia.Objetos.SecaoSeedRandomizeInputTempo.change(function() {
                        const __this = this;
                        setTimeout(function() {
                            const tempo = $(__this).get(0).number();
                            clearInterval(_this.Instancia.Objetos.SecaoSeedRandomizeInterval);
                            if (tempo !== null) {
                                _this.Instancia.Objetos.SecaoSeedRandomizeInterval = setInterval(function() {
                                    if (_this.Container.find('.botoes .btn.desativar').hasClass('ativo')) { return; }
                                    const customizado = _this.Container.find('.botoes .btn.ativo').hasClass('trocarCustomizado');
                                    _this.Instancia.Objetos.SecaoSeedRandomizeInput.val(_this.Instancia.LuckygamesIo.ClientSeed(true, customizado));
                                }, tempo * 1000);
                            }
                        }, 100);
                    });

                    this.Container.find('.seed .trocar, .seed .trocarCustomizado').click(function() {                        
                    ...
                    setTimeout(() => { _this.Container.find('.botoes .btn.trocarCustomizado').click(); }, 1000);
                };
                ...
                this.OnAjaxResponse = function(response, request) {
                    ...
                    _this.Dados.apostas++;
                    _this.Dados.apostasPerdidas = response.gameResult === 'lose' ? _this.Dados.apostasPerdidas + 1 : 0;
                    _this.Dados.apostasVencidas = response.gameResult === 'win' ? _this.Dados.apostasVencidas + 1 : 0;

                    const apostas = _this.Instancia.Objetos.SecaoSeedRandomizeInputApostas.get(0).number();
                    const apostasPerdidas = _this.Instancia.Objetos.SecaoSeedRandomizeInputApostasPerdidas.get(0).number();
                    const apostasVencidas = _this.Instancia.Objetos.SecaoSeedRandomizeInputApostasVencidas.get(0).number();
                    ...
                    if (apostasPerdidas !== null && _this.Dados.apostasPerdidas >= apostasPerdidas) {
                        _this.Dados.apostasPerdidas = 0;
                        trocar = true;
                    }
                    if (apostasVencidas !== null && _this.Dados.apostasVencidas >= apostasVencidas) {
                        _this.Dados.apostasVencidas = 0;
                        trocar = true;
                    }
                ...
                this.ValidarParametros = function(exibirAlerta) {
                    const tempo = _this.Instancia.Objetos.SecaoSeedRandomizeInputTempo.get(0).number();
                    const apostas = _this.Instancia.Objetos.SecaoSeedRandomizeInputApostas.get(0).number();
                    const apostasPerdidas = _this.Instancia.Objetos.SecaoSeedRandomizeInputApostasPerdidas.get(0).number();
                    const apostasVencidas = _this.Instancia.Objetos.SecaoSeedRandomizeInputApostasVencidas.get(0).number();
                    ...
                    if (!result && exibirAlerta && !_this.validarParametrosEmExibicao) {
                        ...
                        _this.Instancia.Geral.Toast('error', _this.Instancia.Geral.FormatarString('O {0} tem um ou mais par&acirc;metros inv&aacute;lidos.', _this.Titulo));
                        setTimeout(function() { _this.validarParametrosEmExibicao = false; }, 1000);
                    }
                    return result;
                };
            ...
            new (function(instancia) {
                ...
                this.Js = function() {
                    _this.Instancia.Objetos.SecaoBotMartingaleInputApostaInicial = this.Container.find('.apostaInicial input');
                    _this.Instancia.Objetos.SecaoBotMartingaleInputSequenciasPerdendo = this.Container.find('.sequenciasPerdendo input');
                    _this.Instancia.Objetos.SecaoBotMartingaleInputEspera = this.Container.find('.espera input');
                    _this.Instancia.Objetos.SecaoBotMartingaleDivMaximoSequenciasPerdendo = this.Container.find('.apostaInicial div span');

                    _this.Instancia.Objetos.SecaoBotMartingaleInputApostaInicial.blur(function() {
                        const apostaInicial = $(this).get(0).number();
                        const saldoInicial = _this.Instancia.LuckygamesIo.ValorSaldo();

                        if (apostaInicial !== null && apostaInicial > 0 && saldoInicial !== null && saldoInicial > 0) {
                            let sequencias = 0;
                            ...
                            _this.Instancia.Objetos.SecaoBotMartingaleDivMaximoSequenciasPerdendo.html(sequencias);
                        }
                        else {
                            _this.Instancia.Objetos.SecaoBotMartingaleDivMaximoSequenciasPerdendo.html('&dash; &dash; &dash;');
                        }
                    });
                ...
                this.ManterAtivado = function() {
                    if (_this.manterAtivadoTimeout === null) {
                        _this.Instancia.Geral.Toast('info', _this.Instancia.Geral.FormatarString('ATIVADO SEMPRE. Caso desative por erro de rede, reativa automaticamente. Os limites definidos continuam v&aacute;lidos.', _this.Titulo));
                        ...
                        _this.Container.find('.botoes .btn.desativar').click();
                        _this.Instancia.Geral.Toast('info', _this.Instancia.Geral.FormatarString('ATIVADO SEMPRE cancelado.', _this.Titulo));
                    }
                };
                ...
                this.FazerApostas = function() {
                    if (_this.fazerApostasEmAndamento) {
                        _this.Container.find('.botoes .btn.desativar').click();
                        _this.Instancia.Geral.Toast('error', _this.Instancia.Geral.FormatarString('Apostas em andamento para recuperar o valor inicial. Aguarde ou atualize a p&aacute;gina para parar.', _this.Titulo));
                        return;
                    }
                    ...
                    const fApostar = function(aposta) {
                        aposta = aposta !== undefined ? aposta : _this.Instancia.Objetos.SecaoBotMartingaleInputApostaInicial.get(0).number();
                        _this.Instancia.LuckygamesIo.Apostar({
                            aposta: aposta,
                            predicao: predicao
                        }).then((data) => {
                            if (!data) { //Execucao duplicada. Ignorar.
                                return;
                            }
                            else if (!data.response && !data.request) { //Limite disparado.
                                _this.fazerApostasEmAndamento = false;
                                _this.Container.find('.botoes .btn.desativar').click();
                            }
                            else if (!data.response) { //Erro de rede. Tenta novamente.
                                fApostar(aposta);
                            }
                            else if (data.response.gameResult === 'win') { //Venceu. Usa aposta inicial.
                                perdas = 0;
                                if (!_this.Container.find('.botoes .btn.desativar').hasClass('ativo')) {
                                    fApostar();
                                }
                                else {
                                    _this.fazerApostasEmAndamento = false;
                            ...
                            else if (data.response.gameResult === 'lose') { //Perdeu. Dobra a aposta.
                                perdas++;
                                if (_this.Instancia.Objetos.SecaoBotMartingaleInputSequenciasPerdendo.get(0).number() >= data.estatisticas.sequenciaPerdendo) {
                                    const esperaNivel = _this.Instancia.Objetos.SecaoBotMartingaleInputEspera.get(0).number();
                                    let esperarRodadas;
                                    switch (esperaNivel) {
                                        case 0: esperarRodadas = 0; break;
                                        case 1: esperarRodadas = parseInt(Math.random() * 10); break;
                                        case 2: esperarRodadas = Math.pow(perdas, 2) + parseInt(Math.random() * 10); break;
                                        default: esperarRodadas = Math.pow(perdas + (esperaNivel - 1), 3) + parseInt(Math.random() * 10);
                                    }
                                    const fEsperar = function(data) {
                                        if (esperarRodadas > 0 || (data && data.response && data.response.gameResult === 'lose')) {
                                            esperarRodadas--;
                                            _this.Instancia.LuckygamesIo.Apostar({ predicao: predicao }).then(fEsperar);
                                        }
                                        else {
                                            fApostar(aposta * 2);
                                        }
                                ...
                                _this.Instancia.Geral.Toast('error', _this.Instancia.Geral.FormatarString('O {0} foi interrompido. Saldo insuficiente para a &uacute;ltima aposta.', _this.Titulo));
                                _this.fazerApostasEmAndamento = false;
                                _this.Container.find('.botoes .btn.desativar').click();
                            }
                        });
            ...
            new (function(instancia) {
                ...
                this.Js = function() {
                    _this.Instancia.Objetos.SecaoBotNinitygaleInputApostaInicial = this.Container.find('.apostaInicial input');
                    _this.Instancia.Objetos.SecaoBotNinitygaleInputSequenciasPerdendo = this.Container.find('.sequenciasPerdendo input');
                    _this.Instancia.Objetos.SecaoBotNinitygaleInputSequenciasPerdendo2 = this.Container.find('.sequenciasPerdendo2 input');
                    _this.Instancia.Objetos.SecaoBotNinitygaleDivMaximoSequenciasPerdendo = this.Container.find('.apostaInicial div span');

                    _this.Instancia.Objetos.SecaoBotNinitygaleInputApostaInicial.blur(function() {
                        const apostaInicial = $(this).get(0).number();
                        const saldoInicial = _this.Instancia.LuckygamesIo.ValorSaldo();
                        ...
                        if (apostaInicial !== null && apostaInicial > 0 && saldoInicial !== null && saldoInicial > 0) {
                            ...
                            while (saldo > 0 && aposta < saldo) {
                                saldo -= aposta;
                                aposta = ((saldoInicial + (apostaInicial * multiplicador)) - saldo) / multiplicador;
                                sequencias++;
                            }
                            _this.Instancia.Objetos.SecaoBotNinitygaleDivMaximoSequenciasPerdendo.html(sequencias);
                        }
                        else {
                            _this.Instancia.Objetos.SecaoBotNinitygaleDivMaximoSequenciasPerdendo.html('&dash; &dash; &dash;');
                        }
                    });
                ...
                this.FazerApostas = function() {
                    ...
                    const apostaInicial = _this.Instancia.Objetos.SecaoBotNinitygaleInputApostaInicial.get(0).number();
                    const multiplicador = 98;
                    const predicao = 98;
                    ...
                    const fApostar = function() {
                        saldoInicial = saldoInicial !== null ? saldoInicial : _this.Instancia.LuckygamesIo.ValorSaldo();
                        const saldo = _this.Instancia.LuckygamesIo.ValorSaldo();
                        const aposta = ((saldoInicial + (apostaInicial * multiplicador)) - saldo) / multiplicador;
                        ...
                        _this.Instancia.LuckygamesIo.Apostar({
                            ...
                            if (!data) { //Execucao duplicada. Ignorar.
                                ...
                                if (apostaMinimaMinima === null) {
                                    apostaMinima = _this.Instancia.Objetos.SecaoBotNinitygaleInputSequenciasPerdendo.get(0).number();
                                }
                                else {
                                ...
                                var fProcessar = () => {
                                    if (apostaMinima < data.estatisticas.sequenciaPerdendo) {
                                        apostaMinimaMinima = _this.Instancia.Objetos.SecaoBotNinitygaleInputSequenciasPerdendo2.get(0).number();
                                        const fEsperar = function(data) {
                                            if (data === undefined || (data.response && data.response.gameResult === 'lose')) {
                                                _this.Instancia.LuckygamesIo.Apostar({ predicao: predicao }).then(fEsperar);
                                            }
                                            else {
                                                fApostar();
                                ...
                                if (data.estatisticas.sequenciaPerdendo % 100 === 0) { setTimeout(fProcessar, 2000 + 1000 * (data.estatisticas.sequenciaPerdendo / 100)); }
                                else { fProcessar(); }
                            }
                            else {
                                _this.Instancia.Geral.Toast('error', _this.Instancia.Geral.FormatarString('O {0} foi interrompido. Saldo insuficiente para a &uacute;ltima aposta.', _this.Titulo));
