...
if (window.Glasgow.Modulos) {
    window.Glasgow.Modulos.Espera = window.Glasgow.Modulos.Espera || new (function() {
        ...
        Modulo.Inicializar = () => {
            ...
            console.logg('Modulo Espera carregado.');
        };
            ...
            html: `
                ...
                <table class="params">
                    <tr>
                        ...
                        <td valign="bottom"><label>Esperar quantos milesegundos</label></td>
                    </tr>
                    ...
                    <tr class="apostaQuantidade">
                        ...
                        <td><input type="text" number number-digitos="0" number-min="1" number-max="9999" number-padrao="1000" value="1000" maxlength="4" /></td>
                    </tr>
        ...
        Modulo.Params = {
            ...
            fVariador: () => {
                if (!Number.isFinite(Modulo.Params.variador)) { return 1; }
                    ...
                    const sinal = parseInt(Math.random() * 100) % 2 === 0 ? -1 : 1;
                    const percentual = Math.floor((Math.random() * Modulo.Params.variador) + 1);
                    return parseInt(1 + (sinal * percentual / 100)); 
                }
            }
        };
