...
if (window.Glasgow.Modulos) {
    window.Glasgow.Modulos.TrocaSeed = window.Glasgow.Modulos.TrocaSeed || new (function() {
        ...
        Modulo.Inicializar = () => {
            ...
            Instancia.InterceptadorAjax.Anexar('ModuloTrocaSeed', 'request', 10, Modulo.AntesDaAposta);
            Instancia.InterceptadorAjax.Anexar('ModuloTrocaSeed', 'response', 10, Modulo.DepoisDaAposta);
            console.logg('Modulo TrocaSeed carregado.');
        };
        ...
        Modulo.Secao = {
            ...
            js: (container) => {
                ...
                container.find('button.gerar').click(() => {
        ...
        Modulo.ObterSeedServidor = (notPromise) => {
            const fObterSeed = (resolve) => {
                if (Modulo.AjaxPendente.ObterSeedServidor) {
                    resolve(Instancia.LuckygamesIo.Objetos.clientSeed.value);
                    return; 
                }
                Modulo.AjaxPendente.ObterSeedServidor = true;
                ...
                .always(() => {
                    Modulo.AjaxPendente.ObterSeedServidor = false;
                });
            };
        ...
        Modulo.ObterSeedCustomizado = (notPromise) => {
            const fObterSeed = (resolve) => {
                if (Modulo.AjaxPendente.ObterSeedCustomizado) {
                    resolve(Instancia.LuckygamesIo.Objetos.clientSeed.value);
                    return; 
                }
                Modulo.AjaxPendente.ObterSeedCustomizado = true;
                ...
                .always(() => {
                    Modulo.AjaxPendente.ObterSeedCustomizado = false;
                });
            };
