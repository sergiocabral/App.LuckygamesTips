  ...
  UNIQUE KEY `un_link_identificador` (`identificador`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='Lista de acessos ao script do robô Glasgow.';");
    ...
    public static function CriarDadosIniciais(BancoConexaoMySQL $bd = null) {
        if (count((new EntidadeBdLink($bd))->Listar()) === 0) {
            $padrao = [
                'script' => 'C:\inetpub\wwwroot\Glasgow\scripts\glasgow.js',
                'cabot' => 'C:\inetpub\wwwroot\Glasgow\scripts\cabot.js',
                'gamebot' => 'C:\inetpub\wwwroot\Glasgow\scripts\gamebot.js',
                'first' => 'C:\inetpub\wwwroot\Glasgow\scripts\first.js',
            ];
