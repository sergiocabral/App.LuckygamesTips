...
class EntidadeBdAcessoHistorico extends EntidadeBd {
  ...
  `provedor` varchar(100) COMMENT 'Provedor de internet.',
  `latlng` varchar(50) COMMENT 'Latitude e Longitude.',
  `idioma` varchar(10) COMMENT 'Idioma do usuário.',
  `navegador` varchar(10) COMMENT 'Navegador de internet.',
  `plataforma` varchar(10) COMMENT 'Sistema operacional.',
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='Lista completa de acessos ao script do robô Glasgow.';");
        }
    }
